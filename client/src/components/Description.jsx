...
const Description = () => {
  return (
    <motion.div className='flex flex-col justify-center items-center p-6 my-24 md:px-28'
    ...
    >
      ...
      <div className='flex flex-col gap-5 md:gap-14 md:flex-row items-center'>
        <motion.img className='w-60 xl:w-96 rounded-lg shadow-lg' src={assets.sample_img_1} alt="Description"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
